...
type ComplexityRoot struct {
	Mutation struct {
		Set func(childComplexity int, data string) int
	}
...
type MutationResolver interface {
	Set(ctx context.Context, data string) (bool, error)
}
type QueryResolver interface {
	Get(ctx context.Context) (string, error)
	Login(ctx context.Context, username string, password string) (*model.TokenResponse, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.set":
		...
		return e.complexity.Mutation.Set(childComplexity, args["data"].(string)), true
...
func (ec *executionContext) _Mutation_set(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().Set(rctx, fc.Args["data"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_login(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNTokenResponse2ᚖgithubᚗcomᚋTsaoLunᚋportalᚋfiberᚑserverᚋgraphᚋmodelᚐTokenResponse(ctx, field.Selections, res)
}
...
func (ec *executionContext) fieldContext_Query_login(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "ok":
				return ec.fieldContext_TokenResponse_ok(ctx, field)
			case "token":
...
func (ec *executionContext) _TokenResponse_ok(ctx context.Context, field graphql.CollectedField, obj *model.TokenResponse) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_TokenResponse_ok(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_TokenResponse_ok(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
...
func (ec *executionContext) marshalNTokenResponse2githubᚗcomᚋTsaoLunᚋportalᚋfiberᚑserverᚋgraphᚋmodelᚐTokenResponse(ctx context.Context, sel ast.SelectionSet, v model.TokenResponse) graphql.Marshaler {
	return ec._TokenResponse(ctx, sel, &v)
}

func (ec *executionContext) marshalNTokenResponse2ᚖgithubᚗcomᚋTsaoLunᚋportalᚋfiberᚑserverᚋgraphᚋmodelᚐTokenResponse(ctx context.Context, sel ast.SelectionSet, v *model.TokenResponse) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
